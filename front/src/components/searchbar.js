...
class ButtonAppBar extends Component {
	...
	onSearchClick = () => {
		this.state.isSearchOpen ? this.handleSearch() : this.setState({ isSearchOpen: true })
	}
	...
	render() {
		...
		return (
			<div className={classes.root}>
				<AppBarMenuItem toggleDrawer={toggleDrawer} linkId="about" content="About" />
				<SvgIcon viewBox="0 0 24 24" className={classes.searchSVG} onClick={this.onSearchClick}>
				...
				<Input
					...
					endAdornment={
						<InputAdornment position="end">
							<IconButton aria-label="Close search input" onClick={this.closeInput}>
								<Close />
							</IconButton>
						</InputAdornment>
					}
