		...
		<div className={classes.section}>
			...
			<GridContainer>
				...
				<GridItem xs={12} sm={6} md={6}>
					<Card raised background style={{ backgroundImage: 'url(' + blog8 + ')' }}>
						<CardBody background>
							...
							<Button round href="#pablo" color="twitter">
								<FormatAlignLeft className={classes.icons} /> Read article
							</Button>
						</CardBody>
					</Card>
				...
				<GridItem xs={12} sm={6} md={6}>
					<Card raised background style={{ backgroundImage: 'url(' + blog8 + ')' }}>
						<CardBody background>
							<h6 className={classes.category}>RECIPES</h6>
							<a href="#pablo">
								<h3 className={classes.cardTitle}>Cooking on Wallstreet is Not So Easy</h3>
							</a>
							<p className={classes.category}>
								Don't be scared of the truth because we need to restart the human foundation in truth
								And I love you like Kanye loves Kanye I love Rick Owens’ bed design but the back is...
				...
				<GridItem xs={12} sm={6} md={6}>
					<Card raised background style={{ backgroundImage: 'url(' + blog8 + ')' }}>
						<CardBody background>
							<h6 className={classes.category}>TECH</h6>
							<a href="#pablo">
								<h3 className={classes.cardTitle}>Working on Wallstreet is Not So Easy</h3>
							</a>
							<p className={classes.category}>
