					...
					<div id="morphingCards" className="cd-section">
						<div className={classes.container}>
							...
							<GridContainer>
								<GridItem xs={12} sm={6} md={6} lg={4}>
									<div
										className={`${classes.rotatingCardContainer} ${classes.manualRotate} ${this
											.state.activeRotate1}`}
									>
										<Card className={classes.cardRotate}>
											<div className={classes.front}>
						...
						<GridContainer>
							<GridItem xs={12} sm={7} md={7}>
								<div className={classes.title}>
									...
									<h4>
										Material Kit PRO is coming with the famous colored shadows. That means each
										image from the cards is getting an unique color shadow. You don't have to do
										anything to activate them, just enjoy the new look of your website.
									</h4>
									<br />
								</div>
							</GridItem>
