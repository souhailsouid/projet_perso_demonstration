							...
							<Card plain className={classes.card2}>
								...
								<CardBody plain>
									...
									<p className={`${classes.description} ${classes.marginTop20}`}>
										Material Kit is a Free Material-UI Kit with a fresh, new design inspired by
										Google's material design. It's a great pleasure to introduce to you the material
