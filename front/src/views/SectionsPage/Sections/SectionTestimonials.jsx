							...
							<Card testimonial className={classes.card1}>
								...
								<CardBody>
									<h5 className={classes.cardDescription}>
										...
										truth. That's why I love you like Kanye loves Kanye I love Rick Owens’ bed
									...
									<Card testimonial plain className={classes.card2}>
										...
										<CardBody plain>
											<h5 className={classes.cardDescription}>
												...
												directly at the old guard on behalf of the future. My brother Chance!!!<br />Thank
												you for letting me work on this masterpiece. One of my favorite people."
											</h5>
						...
						<GridItem xs={12} sm={4} md={4}>
							<Card testimonial plain>
								...
								<CardBody plain>
									...
									<h5 className={classes.cardDescription}>
										"I speak yell scream directly at the old guard on behalf of the future. I gotta
										say at that time I’d like to meet Kanye I speak yell scream directly at the old
							...
							<Card testimonial plain>
								...
								<CardBody plain>
									...
									<h5 className={classes.cardDescription}>
										...
										Hidden Hills compound... Royère doesn't make a Polar bear bed but the Polar
										bear. This is a very nice testimonial about this company."
									</h5>
								</CardBody>
							</Card>
						</GridItem>
